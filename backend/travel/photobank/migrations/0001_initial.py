    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('NEW', 'New'), ('INP', 'In Progress'), ('RED', 'Ready'), ('DEL', 'Deleted')], default='NEW', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='photobank.photo')),
            ],
            options={
