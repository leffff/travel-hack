  ...
  return (
    <>
      <UserHeader
        title="Фотографии"
        body={
          "Наш портал предлагает огромный выбор фотографий высокого качества, подходящих для любых\nпроектов. Найдите идеальное изображение для вашего сайта или рекламной кампании с нами."
        }
      />
